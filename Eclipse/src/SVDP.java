...
public class SVDP {
	...
	// Tested params
	public double LRATE_MW_INITIAL = 1.43e-3;
	public double LRATE_UB_INITIAL = 1.563e-3;
	public double LRATE_MB_INITIAL = 2.285e-3;
	public double K_MW = 0.05284;
	public double K_UB = 0.4909;
	public double K_MB = 4.027e-3;
	public double K_UF = 0.04640;
	...
	public SVDP(int numFeatures, int testParam) {
		this.NUM_FEATURES = numFeatures;
	...
	public SVDP(int numFeatures, double LRATE_BIAS, double LRATE_FEATURES,
	...
	private void initializeVars() {
		...
		mw = new double[NUM_MOVIES][NUM_FEATURES];
	...
	public static void main(String[] args) throws NumberFormatException,
		...
		SVDP trainer;
		if (args.length == 1) {
			trainer = new SVDP(Integer.parseInt(args[0]));
		} else if (args.length == 2) {
			trainer = new SVDP(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
