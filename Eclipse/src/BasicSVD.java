...
public class BasicSVD {
	...
	public double K_FEATURES_INITIAL = 0.02;
	...
	public BasicSVD(int numFeatures) {
	...
	public BasicSVD(int numFeatures, int testParam) {
		this.NUM_FEATURES = numFeatures;
	...
	public BasicSVD(int numFeatures, double LRATE_BIAS, double LRATE_FEATURES,
	...
	private void generateOutput() throws IOException {
		FileWriter fstream = new FileWriter("BasicSVD_1234_with_probe_training");
		...
		fstream = new FileWriter("BasicSVD_5_with_probe_training");
	...
	private void generateProbeOutput() throws IOException {
		FileWriter fstream = new FileWriter("BasicSVD_123_no_probe_training");
		BufferedWriter out = new BufferedWriter(fstream);
		int user;
		short movie, date;
		double predictedRating;
		...
		fstream = new FileWriter("BasicSVD_4_no_probe_training");
		out = new BufferedWriter(fstream);
		// Test the model in probe set.
		for (int j = 0; j < probeData.length; j++) {
			user = probeData[j][0];
	...
	public static void main(String[] args) throws NumberFormatException,
		...
		BasicSVD trainer;
		if (args.length == 1) {
			trainer = new BasicSVD(Integer.parseInt(args[0]));
